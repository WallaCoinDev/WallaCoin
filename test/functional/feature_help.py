...
"""Verify that starting wallacoin with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start wallacoin with -? for help text")
        ...
        self.log.info("Start wallacoin with -version for version information")
