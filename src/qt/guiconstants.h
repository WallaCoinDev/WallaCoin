...
/* Wallacoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Wallacoin"
#define QAPP_ORG_DOMAIN "wallacoin.org"
#define QAPP_APP_NAME_DEFAULT "Wallacoin-Qt"
#define QAPP_APP_NAME_TESTNET "Wallacoin-Qt-testnet"
