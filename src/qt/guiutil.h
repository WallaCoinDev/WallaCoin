...
/** Utility functions used by the Wallacoin Qt UI.
 */
namespace GUIUtil
{
...
// Render WALLA addresses in monospace font
...
// Parse "wallacoin:" URI into recipient object, return true on successful parsing
