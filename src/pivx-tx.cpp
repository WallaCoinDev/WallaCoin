...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Wallacoin wallacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  wallacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded wallacoin transaction") + "\n" +
                               "  wallacoin-tx [options] -create [commands]   " + _("Create hex-encoded wallacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded wallacoin transaction
