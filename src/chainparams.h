...
#define __PORT_MAINNET__ 8112
#define __PORT_TESTNET__ 18112
#define __PORT_REGTEST__ 28112
 ...
 * Wallacoin system. There are three: the main network on which people trade goods
