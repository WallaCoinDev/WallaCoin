...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* WALLA features */
        {"wallacoin", "listmasternodes", &listmasternodes, true },
        {"wallacoin", "getmasternodecount", &getmasternodecount, true },
        {"wallacoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"wallacoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"wallacoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"wallacoin", "masternodecurrent", &masternodecurrent, true },
        {"wallacoin", "startmasternode", &startmasternode, true },
        {"wallacoin", "createmasternodekey", &createmasternodekey, true },
        {"wallacoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"wallacoin", "listmasternodeconf", &listmasternodeconf, true },
        {"wallacoin", "getmasternodestatus", &getmasternodestatus, true },
        {"wallacoin", "getmasternodewinners", &getmasternodewinners, true },
        {"wallacoin", "getmasternodescores", &getmasternodescores, true },
        {"wallacoin", "preparebudget", &preparebudget, true },
        {"wallacoin", "submitbudget", &submitbudget, true },
        {"wallacoin", "mnbudgetvote", &mnbudgetvote, true },
        {"wallacoin", "getbudgetvotes", &getbudgetvotes, true },
        {"wallacoin", "getnextsuperblock", &getnextsuperblock, true },
        {"wallacoin", "getbudgetprojection", &getbudgetprojection, true },
        {"wallacoin", "getbudgetinfo", &getbudgetinfo, true },
        {"wallacoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"wallacoin", "mnfinalbudget", &mnfinalbudget, true },
        {"wallacoin", "checkbudgets", &checkbudgets, true },
        {"wallacoin", "mnsync", &mnsync, true },
        {"wallacoin", "spork", &spork, true },
...
{
    return "> wallacoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8113/\n";
}
