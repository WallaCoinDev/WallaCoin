...
CAmount CMasternode::GetMasternodeNodeCollateral(int nHeight) 
{
    ...
    if (nHeight >  1400000) return    200000 * COIN;
    if (nHeight >  1300000) return    180000 * COIN;
    if (nHeight >  1200000) return    180000 * COIN;
    if (nHeight >  1100000) return    150000 * COIN;
    if (nHeight >  1000000) return    150000 * COIN;
    if (nHeight >  900000) return     120000 * COIN;
    if (nHeight >  800000) return     100000 * COIN;
    if (nHeight >  700000) return     80000 * COIN;
    if (nHeight >  600000) return     60000 * COIN;
    if (nHeight >  500000) return     50000 * COIN;
    if (nHeight >  400000) return     40000 * COIN;
    if (nHeight >  300000) return     30000 * COIN;
    if (nHeight >  250000) return     25000 * COIN;
    if (nHeight >  200000) return     20000 * COIN;
    if (nHeight >  150000) return     15000 * COIN;
...
{
     if (nHeight >   1000) return GetBlockValue(nHeight) * 65 / 100;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 WALLA tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 WALLA tx -> 1 confirmation
