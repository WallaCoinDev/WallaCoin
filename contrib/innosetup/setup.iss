...
#define MyAppName "Wallacoin"
#define MyAppPublisher "2022 Wallacoin developers"
#define MyAppURL "https://wallacoin.shop/"
#define MyAppExeName "wallacoin-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/WALLA/bootstrap.zip"
...
DefaultDirName={autopf}\Wallacoin
...
OutputDir=.\output
OutputBaseFilename=WallacoinSetup
...
DefaultGroupName=Wallacoin Core
...
[Files]
Source: ".\package\wallacoin-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Wallacoin\Wallacoin-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Wallacoin\Wallacoin-Qt,strDataDir|{userappdata}\Wallacoin\}');
  Result := True;
end;
