...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='wallacoin.conf'
CONFIGFOLDER='/root/.wallacoin'
COIN_DAEMON='wallacoind'
COIN_CLI='wallacoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Wallacoin/Wallacoin/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
...
# ADDNODES:
addnode=seed01.wallacoin.shop
addnode=seed02.wallacoin.shop
addnode=seed03.wallacoin.shop
addnode=seed04.wallacoin.shop
addnode=seed05.wallacoin.shop
addnode=seed06.wallacoin.shop
addnode=seed07.wallacoin.shop
addnode=seed08.wallacoin.shop
addnode=seed09.wallacoin.shop
addnode=seed10.wallacoin.shop
