...
#man pages
Source20:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/wallacoind.1
Source21:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/wallacoin-cli.1
Source22:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/wallacoin-qt.1
...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/wallacoin.ico %{buildroot}%{_datadir}/pixmaps/wallacoin.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/pivx.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wallacoin16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wallacoin32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wallacoin64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wallacoin128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/wallacoin256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/wallacoin256.png %{buildroot}%{_datadir}/pixmaps/wallacoin16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/wallacoin256.png %{buildroot}%{_datadir}/pixmaps/wallacoin32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/wallacoin256.png %{buildroot}%{_datadir}/pixmaps/wallacoin64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/wallacoin256.png %{buildroot}%{_datadir}/pixmaps/wallacoin128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/wallacoin256.png %{buildroot}%{_datadir}/pixmaps/wallacoin256.xpm
