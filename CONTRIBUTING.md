Contributing to Wallacoin Core
============================

The Wallacoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/wallacoincrypto/wallacoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Wallacoin Core project, and is not to be
confused with overall Wallacoin Network Protocol consensus changes.

Whether a pull request is merged into Wallacoin Core rests with the project merge
...
Patches that change Wallacoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Wallacoin consensus, it must have been
...
The project leader is the release manager for each Wallacoin Core release.
